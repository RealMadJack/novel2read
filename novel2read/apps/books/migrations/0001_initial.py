    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit', models.CharField(blank=True, choices=[('webnovel', 'Webnovel'), ('boxnovel', 'Boxnovel'), ('wuxiaworld', 'WuxiaWorld'), ('gravitytails', 'GravityTails'), ('lnmtl', 'LNMTL')], default='webnovel', max_length=55)),
                ...
                ('revisit', models.CharField(blank=True, choices=[('webnovel', 'Webnovel'), ('boxnovel', 'Boxnovel'), ('wuxiaworld', 'WuxiaWorld'), ('gravitytails', 'GravityTails'), ('lnmtl', 'LNMTL')], default='webnovel', max_length=55)),
                ...
                ('status_release', models.IntegerField(choices=[(0, 'ongoing'), (1, 'completed')], default=0)),
