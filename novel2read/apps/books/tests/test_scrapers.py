...
class BookScraperTest(TestCase):
    ...
    def test_wn_book_get_data(self):
        ...
        pprint(resp)
        self.assertTrue(isinstance(resp[0]['book_name'], str))
        self.assertTrue(isinstance(resp[0]['book_name_sm'], str))
        self.assertTrue(isinstance(resp[0]['book_info_genre'], str))
        self.assertTrue(isinstance(resp[0]['chap_release'], int))
        self.assertTrue(isinstance(resp[0]['book_info_chap_count'], int))
        self.assertTrue(isinstance(resp[0]['book_info_author'], str))
        self.assertTrue(isinstance(resp[0]['book_rating'], float))
        self.assertTrue(isinstance(resp[0]['book_poster_url'], str))
        self.assertTrue(isinstance(resp[0]['book_tag_list'], list))
        self.assertNotEqual(len(resp[0]['book_name']), 0)
        self.assertNotEqual(len(resp[0]['book_name_sm']), 0)
        self.assertNotEqual(resp[0]['book_info_chap_count'], 0)
        self.assertNotEqual(len(resp[0]['book_info_genre']), 0)
        self.assertNotEqual(len(resp[0]['book_info_author']), 0)
        self.assertNotEqual(len(resp[0]['book_poster_url']), 0)
        self.assertNotEqual(len(resp[0]['book_tag_list']), 0)
