...
ROOT_DIR = environ.Path(__file__) - 3  # (novel2read/config/settings/base.py - 3 = novel2read/)
APPS_DIR = ROOT_DIR.path('novel2read')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///novel2read'),
}
...
MIGRATION_MODULES = {
    'sites': 'novel2read.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Gupalo Dmitry""", 'gupalo1108@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["novel2read.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
